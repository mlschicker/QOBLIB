# Submission for labs008-without_calibration

This directory contains the submission for the problem **labs008-without_calibration**.
...
| ====== |  |
| Total Runtime | 648.782 |
| CPU Runtime | 0.03295 |
| GPU Runtime | N/A |
| QPU Runtime | 641.974 |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | without calibration; ground state probability: 6.72% |
